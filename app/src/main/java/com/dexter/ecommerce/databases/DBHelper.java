...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public final static String DBATABASE_NAME = "ecommerce.db";
    public final static int DBATABASE_VERSION = 1;
    ...
    private static final String TABLE_CREATE =
            "CREATE TABLE " + TABLE_ORDERS + " (" +
                    ...
                    COLUMN_TOTAL_PRICE + " NUMERIC " +
                    ")";

    public DBHelper(Context context) {
        super(context, DBATABASE_NAME, null, DBATABASE_VERSION);
    }
