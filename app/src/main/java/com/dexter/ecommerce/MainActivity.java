...
import com.dexter.ecommerce.adapters.AdapterMainMenu;
import com.dexter.ecommerce.adapters.AdapterNavDrawerList;
import com.dexter.ecommerce.databases.DBHelper;
...
//        dataSource.open();
//
//        List<OrderData> orders = dataSource.findAll();
//        if (orders.size() == 0) {
//            createData();
...
//			throw new Error("Unable to addMyOrder database");
//		}
